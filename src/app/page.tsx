    ...
    <main>
      <section className="vh-100 d-flex justify-content-center align-items-center flex-column container">
        ...
        <div className="d-flex flex-column gap-3 buttons-news mt-5">
          <Link href={routes.briefing.first_stage} className="btn btn-outline-main br-25 ff-arame text-main fs-40">Nova proposta</Link>
          <Link href={routes.briefing.first_stage} className="btn btn-outline-dark br-25 ff-arame  fs-40">novo briefing</Link>
        </div>
      </section>
    </main>
  )
